...
var greenOrb,greenOrbImg 
var blueOrb, blueOrbImgm 
var redOrb, redOrbImg
var yellowOrb, yellowOrbImg
...
function preload(){
  ...
  spaceBarImg = loadImage("sprites/spacebar.jpeg")
}
...
function setup() {
  ...
  spaceBar = createSprite(400,200)
  spaceBar.addImage("spacebar", spaceBarImg)
}
...
function draw() {
  background(backgroundImg)
    ...
    if(gameState === playState){
      ...
      if (yoshi.isTouching(greenOrb)) {
        greenOrb.x = yoshi.x
        greenOrb.y = yoshi.y
        greenOrbStatus = true
      }
      if (yoshi.isTouching(yellowOrb)) {
        yellowOrb.x = yoshi.x
        yellowOrb.y = yoshi.y
        yellowOrbStatus = true
      }
      if (yoshi.isTouching(blueOrb)) {
        blueOrb.x = yoshi.x
        blueOrb.y = yoshi.y
        blueOrbStatus = true
      }
      if (yoshi.isTouching(redOrb)) {
        redOrb.x = yoshi.x
        redOrb.y = yoshi.y
        redOrbStatus = true
      }
      ...
      if (mushroom1.isTouching(yoshi) && blueOrbStatus === true) {
      ...
      if (mushroom2.isTouching(yoshi) && greenOrbStatus === true) {
        mushroom2.destroy()
        greenOrb.destroy()
      }
      
      if (bowser.isTouching(yoshi) && yellowOrbStatus === false) {
        gameState = endState
      }
      if (bowser.isTouching(yoshi) && yellowOrbStatus === true) {
        bowser.destroy()
        yellowOrb.destroy()
      }
      
      if (mushroom3.isTouching(yoshi) && redOrbStatus === false) {
        gameState = endState
      }
      if (mushroom3.isTouching(yoshi) && redOrbStatus === true) {
        mushroom3.destroy()
        redOrb.destroy()
      }
    ...
    mushroom1.velocityX = 0
    mushroom1.velocityY = 0
    mushroom2.velocityX = 0
    mushroom2.velocityY = 0
    mushroom3.velocityX = 0
    mushroom3.velocityY = 0
    yoshi.velocityX = 0
    yoshi.velocityY = 0
    bowser.velocityX = 0
    bowser.velocityY = 0
